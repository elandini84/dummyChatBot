...
#ifndef DUMMYCHATBOT_H
#define DUMMYCHATBOT_H
...
*
* @brief `dummyChatBot` : a fake device which implements the IChatBot interface for testing purposes.
*
*/
class DummyChatBot : public yarp::dev::IChatBot,
